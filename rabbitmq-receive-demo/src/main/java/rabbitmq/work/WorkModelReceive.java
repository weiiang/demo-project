 ...
 * @Version 1.0.0
 */
public class WorkModelReceive {
    private static Connection connection = ConnectionUtils.getInstance("127.0.0.1", "/leyou","leyou", "leyou", 5672);

    private static Logger logger = LoggerFactory.getLogger(WorkModelReceive.class);

    public static void receiveMsgOne(String queueName, String msg) throws IOException {
        //从连接中创建通道
...
//        channel.basicQos(1);
        ...
        DefaultConsumer consumer = new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                logger.info("[RECEIVER-ONE]消费:"+ new String(body));
                //手动ACK
    ...
    public static void main(String[] args) throws IOException {
        receiveMsgOne("testWorkQueue", null);
    }
}
